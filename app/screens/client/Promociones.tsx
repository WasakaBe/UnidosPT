...
import {
  fetchPromociones,
  startPromocionesPolling,
  stopPromocionesPolling,
} from '@/app/services/promocionService'
...
export default function Promociones() {
  ...
  useEffect(() => {
    fetchPromociones(idPartido, setPromociones, setLoading)

    // Iniciar polling y almacenar el intervalo en ref
    pollingIntervalRef.current = startPromocionesPolling(
      idPartido,
      setPromociones,
      10000
    )
    ...
    return () => {
      ...
      if (pollingIntervalRef.current) {
        stopPromocionesPolling(pollingIntervalRef.current)
        pollingIntervalRef.current = null // Limpiar referencia
      }
    }
  }, [idPartido])
